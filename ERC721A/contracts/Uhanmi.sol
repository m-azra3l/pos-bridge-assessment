...
contract UhanmiNFT is ERC721A{
    ...
    string baseUrl = "https://gateway.pinata.cloud/ipfs/QmddhUXyNxkV2KDgrX63QJzVg2T26JjDydNjPam84t5YNi/";
    ...
    constructor() ERC721A("Uhanmi", "UHNFT") {
        owner = msg.sender;
    }
